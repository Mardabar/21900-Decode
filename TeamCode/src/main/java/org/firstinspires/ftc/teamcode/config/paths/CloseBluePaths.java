...
public class CloseBluePaths {
    ...
    final Pose row2Line = new Pose(50, 60, Math.toRadians(180)), row2Grab = new Pose(15, 60, Math.toRadians(180)), row2Score = new Pose(50, 93, Math.toRadians(135)), row2ScoreCP = new Pose(53, 58);
    final Pose row2OpenGate = new Pose(16, 70, Math.toRadians(90)), row2OpenGateCP = new Pose(30, 65);
    ...
    public PathChain pathPreScore, pathRow2Line, pathRow2Grab, pathRow2OpenGate, pathRow2Score, pathOpenGate, pathRow1Line, pathRow1Grab, pathRow1Score;
