...
public class CloseBlueTestingPaths {
    ...
    final Pose row1Line = new Pose(52, 84, Math.toRadians(180)), row1Grab = new Pose(13.5, 84, Math.toRadians(180)), row1Score = new Pose(40, 102, Math.toRadians(135)), row1ScoreCP = new Pose(47, 67);
    final Pose row2Line = new Pose(52, 60, Math.toRadians(180)), row2Grab = new Pose(13, 60, Math.toRadians(180)), row2ScoreCP = new Pose(60, 70), row2Score = new Pose(50, 93, Math.toRadians(135));
    final Pose openGate = new Pose(10, 76, Math.toRadians(180)), openGateCP = new Pose(36, 65);
    final Pose r2OpenGate = new Pose(11, 73, Math.toRadians(180)), r2OpenGateCP = new Pose(30, 62);
    final Pose r1OpenGate = new Pose(13, 78, Math.toRadians(180)), r1OpenGateCP = new Pose(42, 78);
    ...
    public CloseBlueTestingPaths(Follower fol){
