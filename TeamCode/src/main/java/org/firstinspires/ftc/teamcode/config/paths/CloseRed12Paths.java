...
public class CloseRed12Paths {
    ...
    final Pose row1Line = new Pose(52, 84, Math.toRadians(180)).mirror(), row1Grab = new Pose(18, 84, Math.toRadians(180)).mirror(), row1Score = new Pose(40, 102, Math.toRadians(135)).mirror(), row1ScoreCP = new Pose(47, 67).mirror();
    final Pose row2Line = new Pose(52, 60, Math.toRadians(180)).mirror(), row2Grab = new Pose(10, 60, Math.toRadians(180)).mirror(), row2ScoreCP = new Pose(60, 70).mirror(), row2Score = new Pose(50, 93, Math.toRadians(135)).mirror();
    ...
    final Pose row3Line = new Pose(52, 35, Math.toRadians(180)).mirror(), row3Grab = new Pose(6, 35, Math.toRadians(180)).mirror(), row3Score = new Pose(48, 107, Math.toRadians(138)).mirror(), row3ScoreCP = new Pose(47.5, 73).mirror();
    ...
    public CloseRed12Paths(Follower fol){
