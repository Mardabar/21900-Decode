...
import org.firstinspires.ftc.teamcode.config.paths.OldCloseBluePaths;
...
public class OldCloseBlue extends NextFTCOpMode {

    ShootSystem shootSystem;
    OldCloseBluePaths paths;
    ...
    private SequentialGroup autonomousRoutine() {
        ...
        paths = new OldCloseBluePaths(PedroComponent.follower());
